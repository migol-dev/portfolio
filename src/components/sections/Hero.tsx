...
function TypedCode() {
  ...
  return (
    <div className="rounded-lg border border-border bg-panel overflow-hidden shadow-2xl shadow-black/40">
      ...
      <pre className="p-4 sm:p-5 text-[13px] sm:text-sm font-mono leading-relaxed overflow-x-auto">
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 w-full">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-green/30 bg-green/10 px-3 py-1 text-xs font-mono text-green mb-6">
            ...
            <p className="max-w-xl text-base sm:text-lg text-text-dim mb-8">
