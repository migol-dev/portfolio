...
export async function PUT(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json({ error: "No se pudo actualizar la habilidad." }, { status: 500 });
  }
}
...
export async function DELETE(_req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    return NextResponse.json({ error: "No se pudo eliminar la habilidad." }, { status: 500 });
  }
}
